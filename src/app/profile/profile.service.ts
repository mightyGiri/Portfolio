...
export class ProfileService {
  ...
  about2 = `Software Developer with 6 years of experience .
  Worked with Software Development Life Cycle(SDLC) and  agile methodologies .
  Expertise in Angular 2+ All versions, Typescript, Javascript, SpringBoot, Java  and UI with Responsive Designs .
  Have good understanding of Python, Jquery, Bootstrap and MYSQL/SQL`

  about = "Contributed more on UI and partial in Java. Made more automation code for migrations, QA testing. Integrated Angular and Python with AWS S3, Excel to DB migration with S3 and lamda."
